...
compileToSparcUclibc.py -I $AJIT_UCLIBC_HEADERS_DIR -I ./ -s init.s -s setup_page_tables.s -s trap_handlers.s -s data.s -s fft.s -c fft_source.c -c ${MAIN}.c -N ${MAIN} -L LinkerScript.lnk  -D AJIT -U -o3 -I  ./home/ayush/eys/ajit-toolchain/wkspace/AJIT-libraries/radix_two_fft
